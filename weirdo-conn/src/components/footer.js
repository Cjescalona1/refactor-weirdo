...
export function Footer(){
    ...
    <div className="foot" id="foot"> 
        ...
        <div className="foot2">
            ...
            <div className="colla">
                <button type="button" className="collapsible collapseButt active" onClick={()=>{openCollapse(0)}}>
                    + What's new on this new staking system?
                </button>
                ...
                <button type="button" className="collapsible collapseButt" onClick={()=>{openCollapse(1)}}>+ You mentioned bonuses! Tell me more.</button>
                <div className={`contentCollapse`}>
                ...
                <button type="button" className="collapsible collapseButt" onClick={()=>{openCollapse(2)}}>+ What should I do to stake my weirdos?</button>
                <div className={`contentCollapse`}>
                ...
                <button type="button" className="collapsible collapseButt "onClick={()=>{openCollapse(3)}}>+ Can I unstake my weirdos whenever I want?</button>
                <div className={`contentCollapse`}>
                <p>Yes, you can withdraw the weirdos from the stake whenever you want, but by doing so you will stop receiving rewards.</p>
                </div> 

                <button type="button" className="collapsible collapseButt " onClick={()=>{openCollapse(4)}}>+ What is the $UWU token used for?</button>
                <div className={`contentCollapse`}>
